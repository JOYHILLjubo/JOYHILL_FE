          ...
          return filtered.map((notice) => {
            ...
            return (
              <div
                ...
                className={`rounded-2xl shadow-sm p-4 mb-2 cursor-pointer transition-colors ${
                  notice.pinned ? 'bg-gray-200 hover:bg-gray-200/70' : 'bg-surface hover:bg-gray-100/60'
                }`}
              >
